    ...
    <div>
      ...
      <div className={styles.boxEdit}>
        ...
        <div className={styles.productDetails}>
          ...
          <form className={styles.formEditProd}>
            ...
            <div className={styles.imagesLabel}>
              ...
              <label>
                ...
                <div className={styles.boxSelectImg}>
                  <input className={styles.customFileUpload}  accept="image/*" type="file" onChange={(e) => setImgProd(URL.EditObjectURL(e.target.files[0]))} />
            ...
            <label className={styles.btnSubmit}>
              <input type="submit" className={styles.btnEdit} value={"Edit Product"} />
            </label>
